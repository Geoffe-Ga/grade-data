...
**Component**: Data quality validation API

**Documentation**: Overview and features, installation/import guide, quick start examples, complete API
reference (with types and error handling), advanced usage patterns, validation rule configurations,
data quality metrics explanation, integration guide for quality control pipelines, migration guide.
